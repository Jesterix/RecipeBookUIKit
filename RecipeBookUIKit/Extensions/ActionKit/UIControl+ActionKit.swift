...
public extension ActionKitControl where Self: UIControl {
    ...
    func addControlEvent(_ controlEvents: UIControl.Event, closureWithControl: @escaping SpecificControlClosure) {
...
public extension UIControl {
    ...
    fileprivate func addControlEvent(_ controlEvents: UIControl.Event, actionKitClosure: ActionKitClosure) {
