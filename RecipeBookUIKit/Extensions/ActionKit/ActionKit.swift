...
class ActionKitSingleton {
    var controlAndEventsDict: Dictionary<UIControl, Dictionary<UIControl.Event, ActionKitClosure>> = Dictionary()
...
extension ActionKitSingleton {
    ...
    func addAction(_ control: UIControl, controlEvent: UIControl.Event, closure: ActionKitClosure)
    {
        if var innerDict = controlAndEventsDict[control] {
            ...
            var newDict = Dictionary<UIControl.Event, ActionKitClosure>()
    ...
    fileprivate func runAllClosures(_ control: UIControl, event: UIControl.Event) {
